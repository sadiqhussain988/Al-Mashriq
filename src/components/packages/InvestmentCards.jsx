      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {investments.map((inv, index) => (
            <div
              key={inv.id}
              className={`relative group cursor-pointer transition-all duration-500 ${selectedCard === inv.id ? 'scale-105' : 'hover:scale-105'
                }`}
            ...
            >
              ...
              {inv.popular && (
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 z-10">
                  <div className="bg-gradient-to-r from-amber-400 to-orange-500 text-white px-6 py-1 rounded-full text-sm font-bold shadow-lg flex items-center gap-1 text-nowrap">
              ...
              {/* Main Card */}
              <div className={`relative bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border-2 ${inv.popular ? 'border-amber-300' : 'border-white'
                ...
                <div className="px-6 pb-6">
                  <Link
                    to="/register"
                    className="block w-full bg-gradient-to-r from-amber-400 to-orange-500 hover:from-amber-500 hover:to-orange-600 text-white font-semibold py-4 rounded-xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95"
                  >
        ...
        <div className="text-center mt-16">
          <p className="text-gray-500 text-sm">
            All investments are secured with our 256-bit SSL encryption and protected by our money-back guarante.
          </p>
        </div>
      </div>
    </div>
