      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                <FaChevronDown
                  className={`text-[#FFBC3B] transition-transform duration-300 ${activeIndex === index ? "rotate-180" : ""
                    }`}
                />
              </button>
              {activeIndex === index && (
        ...
        >
          <img
            ...
            className="w-full max-w-xl rounded-2xl object-cover h-72 md:h-96 transform transition-transform duration-700 ease-in-out hover:scale-110"
          />
        </div>
